# -*- coding: utf-8 -*-
"""
Created on Sat Apr 28 17:01:13 2018
...
classifier.add(Dense(output_dim = 210, init = 'uniform', activation = 'relu', input_dim = 384))

# Adding the second hidden layer
classifier.add(Dense(output_dim = 210, init = 'uniform', activation = 'relu'))
classifier.add(Dense(output_dim = 210, init = 'uniform', activation = 'relu'))
classifier.add(Dense(output_dim = 210, init = 'uniform', activation = 'relu'))
...
classifier.fit(X_train, onehot, batch_size = 40 , nb_epoch = 500)
# Generate dummy data
